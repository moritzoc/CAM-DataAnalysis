uploadServer <- function(id, parent, globals) {
  moduleServer(id, function(input, output, session) {
    ...
    outUI$elements <- tagList(
      h1("Thank you for using our Data Analysis Tool"),
      tags$div(
        HTML(
          'The application is designed to analyse CAM data from our newly developed
                Data Collection Tool (<a href="https://camgalaxy.github.io/?external=true" target="_blank">link to software</a>, '
        ),
        a(
          actionButton(
            inputId = "githubCAMEL",
          ...
          href = "https://github.com/CAM-E-L/DataCollection",
          target = "_blank"
        ),
        HTML(
      ...
      tags$div(
        HTML(
          'To start the application please click on the module option "Upload" on the sidebar panel. The options for
        ...
        tags$ul(
          ...
          tags$li(
            HTML(
              '<b>Information:</b> Further information regarding the application.'
            )
          )
        )
      )
...
>>>>>>> Stashed changes
        ...
        showModal(
          modalDialog(
            ...
            paste0(
              "The file you have uploaded doesn't appear to be a valid protocol as generated by the Data Analysis Tool. Please upload a valid protocol or continue with uploading your raw CAM dataset."
            ),
            easyClose = TRUE,
            footer = tagList(modalButton("Ok"))
          )
